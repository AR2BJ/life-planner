          ...
          >
            <div class="flex items-center gap-3 min-w-0">
              ...
              <div class="min-w-0">
                ...
                >
                  Update plan attributes and manage subplans.
                </p>
              </div>
            </div>
          ...
          >
                ...
                <div class="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p class="text-[10px] lg:text-xs leading-4 text-secondary">
                      Set the core plan details and timeline.
                    </p>
                  </div>
                </div>
                <i
            ...
            >
              ...
              <div class="accordion-content hidden p-3.5 lg:p-4">
                <div class="w-full relative">
                  <div id="edit-plan-tags-container"></div>
                </div>
            ...
            >
              ...
              >
                ...
                >
                  <input
                    id="new-subplan-input"
                    type="text"
                    placeholder="Add a new subplan item..."
