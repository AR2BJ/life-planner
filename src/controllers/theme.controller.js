...
export const ThemeController = {
  updateIcon(theme) {
    ...
    if (theme === "dark") {
      btn.innerHTML = `<i id="btn-sun" class="ti ti-sun text-orange-500/80 text-lg lg:text-xl transition-transform duration-300 ease-in-out"></i>`;
      ...
      `;
      btn.classList.replace("hover:bg-orange-600/10", "hover:bg-slate-600/10");
    }
  },
