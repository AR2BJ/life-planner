...
export const DashboardComponent = {
  render(plans = []) {
    ...
    // const archivedPlans = plans.filter((t) => t.archived);
    ...
    // const completedPlans = activePlans.filter((t) => t.status === "done");
    // const completedCount = completedPlans.length;
    // const BlockedCount = activePlans.filter(
    //   (t) => t.status === "blocked",
    // ).length;
    // const overdueCount = activePlans.filter((t) =>
    //   isOverdue(t.dueDate, t.status),
    // ).length;
    // // Subplans Aggregation
    // let totalSubplans = 0;
    // let completedSubplans = 0;
    // activePlans.forEach((t) => {
    //   if (Array.isArray(t.subplans) && t.subplans.length > 0) {
    //     totalSubplans += t.subplans.length;
    //     completedSubplans += t.subplans.filter((st) => st.completed).length;
    //   }
    // });
    // const subplanRate =
    //   totalSubplans > 0
    //     ? Math.round((completedSubplans / totalSubplans) * 100)
    //     : 0;
    ...
    //   (state.tags.filter((t) => plan.tags.includes(t.id)) || []).forEach(
    //     (tag) => {
    ...
    // const criticalPlans = activePlans.filter(
    //   (t) => t.status !== "done" && t.priority === "high",
    // );
    // const criticalCount = criticalPlans.length;
    // const nearDeadlineCritical = criticalPlans.filter((t) => {
    //   if (!t.dueDate) return false;
    //   const days = getDaysRemaining(t.dueDate);
    //   return days >= 0 && days <= 2;
    // }).length;
    // const unscheduledCount = activePlans.filter(
    ...
    //         </div>
    //         <p class="text-[11px] text-secondary/80 font-medium mt-1">
    //           Active plans without target deadline
    //         </p>
    //       </div>
    //     </div>
    //     <div
    ...
    //         </div>
    //         <p class="text-[11px] text-secondary/80 font-medium mt-1">
    //           Impeded plans requiring resolution
    //         </p>
    //       </div>
    //     </div>
    //     <div
    ...
    //         </div>
    //         <p class="text-[11px] text-secondary/80 font-medium mt-1">
    //           Leading focus area (${topTag[1]} plans)
    //         </p>
    //       </div>
    //     </div>
    //     <div
    ...
    //               Plan density velocity tracking across defined execution
    //               windows.
    //             </p>
    //           </div>
    ...
    //             </h4>
    //             <p class="text-xs text-secondary mt-1">
    //               Proportional distribution of active plans classified by
    //               severity tier.
    //             </p>
    //           </div>
    //           <span
    ...
    //             </h4>
    //             <p class="text-xs text-secondary mt-1">
    //               Lifecycle stage mapping showing plan allocation across
    //               execution states.
    //             </p>
    //           </div>
    //           <span
    ...
    //               Plan-Level Execution & Subplan Progress
    //             </h4>
    //             <p class="text-xs text-secondary/80 mt-0.5 font-medium">
    //               Granular view of active work items, subplan ratios, and
    //               milestone health.
    //             </p>
    //           </div>
    //           <span
    ...
    //                       You're all caught up! Create a new plan to get
    //                       started.
    //                     </p>
    //                   </div>
    //                 `
    //               : plans
    //                   .map((plan) => {
    //                     const subplanInfo = calculateSubplanProgress(
    //                       plan.subplans,
    //                     );
    ...
    //                       subplanInfo.percentage === 100
    //                         ? "bg-emerald-500/80"
    //                         : subplanInfo.percentage <= 65 &&
    //                             subplanInfo.percentage >= 35
    //                           ? "bg-amber-500/80"
    //                           : subplanInfo.percentage <= 35 &&
    //                               subplanInfo.percentage > 0
    //                             ? "bg-red-500/80"
    //                             : subplanInfo.percentage === 0
    //                               ? "bg-slate-500/80"
    //                               : "bg-brand/80";
    ...
    //                                     data-tooltip-title="${plan.description}"
    //                                   >
    //                                     ${plan.description}
    //                                   </p>
    //                                   <p
    ...
    //                               >
    //                               <span
    //                                 class="font-bold ${subplanPercentColor}"
    //                                 >${subplanInfo.completedCount}/${subplanInfo.totalCount}
    //                                 (${subplanInfo.percentage}%)</span
    //                               >
    //                             </div>
    //                             <div
    ...
    //                                 style="width: ${subplanInfo.percentage}%"
    //                               ></div>
    //                             </div>
    //                           </div>
