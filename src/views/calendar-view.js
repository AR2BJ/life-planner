        ...
        >
          ...
          >
            ...
            <button
              ...
              role="tab"
              aria-selected="true"
              class="relative z-10 flex-1 w-full rounded-t-xl py-2 text-sm font-medium text-(--color-btn-primary-text) transition cursor-pointer text-center xs:w-20 xs:rounded-l-xl xs:rounded-tr-none"
            >
              Day
            </button>
            ...
            <button
              ...
              role="tab"
              aria-selected="false"
              class="relative z-10 flex-1 w-full rounded-none py-2 text-sm font-medium text-secondary transition cursor-pointer text-center xs:w-20"
            >
              Month
            </button>
